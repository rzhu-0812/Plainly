        ...
        <main className="max-w-[1440px] mx-auto min-h-[calc(100-4rem)] grid grid-cols-1 lg:grid-cols-12 overflow-hidden">
          <aside className="lg:col-span-4 border-r border-slate-200 dark:border-slate-800 p-8 space-y-10 bg-white dark:bg-[#020617]">
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center justify-between p-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all group shadow-sm">
                <div className="flex items-center gap-3">
                  <Camera className="w-5 h-5 opacity-80" />
                  <span className="font-medium">Scan with Device</span>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-8 border-y border-slate-100 dark:border-slate-800 py-8">
                    ...
                    <div className="md:col-span-8">
                      <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed font-light">
                        A neighbor is requesting to <span className="font-semibold text-slate-900 dark:text-white">expand their storefront</span> by 5 feet. This may impact your sidewalk access. You have 14 days to file an objection if this interferes with your business operations.
                      </p>
                    </div>
                  </div>
